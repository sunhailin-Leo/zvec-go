...
func TestValidatePuregoVersion(t *testing.T) {
	tests := []struct {
		...
		{name: "minimum", major: 0, minor: 7, patch: 0},
		{name: "newer patch", major: 0, minor: 7, patch: 9},
		{name: "older minor", major: 0, minor: 6, patch: 9, wantErr: true},
		{name: "different pre-v1 minor", major: 0, minor: 8, patch: 0, wantErr: true},
